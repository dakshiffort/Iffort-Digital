          ...
          <div className="space-y-12 order-1 lg:order-2">
            <div>
                 ...
                 <p className="text-gray-400 mb-8 leading-relaxed">
                   Skip the sales pitch. We are consultants, not salespeople. Reach out to discuss your digital challenges directly with our expert team.
                 </p>
                 <div className="flex flex-col gap-4">
                  <a href="mailto:kshipra.uniyal@iffort.com" className="flex items-center gap-4 text-gray-300 hover:text-iffort-blue transition-colors group">
                    ...
                    <div>
                        <p className="text-xs text-gray-500 uppercase tracking-wider mb-0.5">Business Enquiries</p>
                        <span className="text-lg">kshipra.uniyal@iffort.com</span>
                    </div>
                  </a>
                </div>
            </div>
